...
public class SuperFrame extends FrameLayout {

	public SuperFrame(final Context context) {
        super(context);
    }
    
    public SuperFrame(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public SuperFrame(Context context, AttributeSet attrs, int defStyle) {
